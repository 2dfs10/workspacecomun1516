...
/**
 * Servlet implementation class ConsultaConcreta
 */
		...
		// Leer el driver especifico de la B.Datos , nuestro caso es MySQL
				...
				PrintWriter out = response.getWriter();
						...
						try {
							...
							// String consulta = "SELECT * FROM `tutorias_t2` WHERE alumno = 'pepito flores'";
							...
							{
								out.println (" No hay ningún dato encontrado!!!!");
